...
p.toLong     = function( data ){ return this.decodeLong( data, 64, true  ); };
p.fromLong   = function( data ){ return this.encodeLong( data, 64, true  ); };
...
// Patch to have full support for longs.
p.encodeLong = function( data ){
...
p.decodeLong = function (data){
  ...
  max = Math.pow( 2, 53);
  return signed && b.readBits(63, 1) !== 0 ? x - max : x;
};
